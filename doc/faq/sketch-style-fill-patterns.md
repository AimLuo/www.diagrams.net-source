...
**Tip:** Use the [shape properties at the bottom of the format panel](/blog/shape-properties.html) to change the jiggle, angle, fill line widths, multi-stroke, zigzag size and dash properties.
