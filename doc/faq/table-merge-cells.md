...
<br /><img src="/assets/img/blog/arrange-tab-unmerge.png" style="width=100%;max-width:500px;height:auto;" alt="Unmerge table cells in the draw.io editor via the Arrange tab in the format panel">

If you are using the Sketch whiteboard-like editor theme, click _+ > Format_ to see the format panel and use the table tools in the _Arrange_ tab. 
