...
* Click on the macro in the Plane page to open the draw.io editor. 
...
**Important:** Diagram changes are not included in the page version history - your page will  display the most recent version of the embedded diagram in all historical versions.
...
While the work item description can only contain text, you can add a draw.io diagram in two ways.
...
As you have probably experienced, diagrams can take some time to draw. Where diagrams are a big part of your project documentation and are assigned to certain team members, add a label to the work items that are diagrams. 
...
Then, add a view that filters for just that label, and displays the work items in a timeline - a handy Gantt chart to plan and track the diagram development schedule.
...
* custom [draw.io editor configurations](/doc/faq/configure-diagram-editor.html)
* [custom shape libraries](/blog/custom-libraries.html) and [custom templates](/blog/custom-template-libraries.html)
* [multi-page diagram](/blog/multiple-page-diagrams.html) display - the Plane page will display the last diagram page tab you had open in the draw.io editor.

As a work around for custom templates, store your template diagrams in GitHub, on a cloud platform or a shared drive within your network and import these files into a new diagram on a Plane page when you need them.
* In the draw.io editor, click _File > Import from > URL_.

**Important note:** This is a third-party integration 

To use any expanded or updated features that you like to use in the [online draw.io editor](https://app.diagrams.net) in the Plane.so integration, please contact Plane.so support and raise a request with them. We have not developed this integration so can not help you with any problems or shortcomings with it.
